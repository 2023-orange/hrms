package com.sunten.hrms.exception.handler;
...
public class GlobalExceptionHandler {
    ...
    /**
     * 处理InfoCheckWarningMessException异常
     */
    @ExceptionHandler(value = InfoCheckWarningMessException.class)
    public ResponseEntity<ApiError> infoCheckWarningMessException(InfoCheckWarningMessException e) {
        return buildResponseEntity(ApiError.error(e.getMessage()));
    }
