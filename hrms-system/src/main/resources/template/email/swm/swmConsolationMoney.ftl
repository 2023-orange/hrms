...
<div style="height: auto;
    ...
    <div style="padding: 10px;padding-bottom: 0px;">
        ...
        <p style="text-indent: 2em; margin-bottom: 10px;">以下为发放名单</p>
        <table style="border: 1px solid #2a2a2d; margin-left: 10px ">
            ...
            <#list swmConsolationMoneyList as swmConsolation>
                <tr>
                    <td>
                        ${swmConsolation_index + 1}
                    </td>
                    <td>
                        ${swmConsolation.workCard}
                    </td>
                    <td>
                        ${swmConsolation.name}
                    </td>
                    <td>
                        ${swmConsolation.consolationMoneyType}
                    </td>
                    <td>
                        ${swmConsolation.releasedMoney}
                    </td>
                    <td>
                        ${swmConsolation.releasedTimeStr}
                    </td>
                </tr>
            </#list>
        </table>
