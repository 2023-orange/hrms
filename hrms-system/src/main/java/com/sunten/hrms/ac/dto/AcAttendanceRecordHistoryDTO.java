...
public class AcAttendanceRecordHistoryDTO extends BaseDTO {
     ...
     * 打卡记录, 定时任务时使用
     */
    private List<AcAbnormalClockRecordDTO> clockRecords;

    private AcAbnormalClockRecordDTO abClockRecord;
